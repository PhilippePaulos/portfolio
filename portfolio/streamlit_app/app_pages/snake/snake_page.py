...
class SnakeApp:
    ...
    def start_game(
        self, prompt_agent_1: str, prompt_agent_2: str, agent_1: str, agent_2: str
    ):
        st.session_state["game_started"] = True
        self.game1.set_strategy_function(prompt_agent_1, agent_1)
        self.game2.set_strategy_function(prompt_agent_2, agent_2)
